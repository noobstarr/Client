package com.jagex.rs2.net;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
import com.jagex.rs2.ClientApplet;

public final class J_Socket
        implements Runnable {

    public J_Socket(ClientApplet RSApplet_, Socket socket1)
            throws IOException {
        closed = false;
        isWriter = false;
        hasIOError = false;
    ...
    private final ClientApplet rsApplet;
    private byte[] buffer;
